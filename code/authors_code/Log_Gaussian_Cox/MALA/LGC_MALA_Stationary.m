...
[D]      = length(y);
StepSize = 1.65^2;  % optimised for stationary phase
Scaling  = (N^2)^(1/3);
...
CurTime = fix(clock);
save(['Results/Results_MALA_Stationary_LogCox_' num2str(N) '_' num2str(floor(now)) '_' num2str(CurTime(4:6)) '.mat'], 'xSaved', 'LJLSaved', 'TimeTaken', 'f_x_ySaved')
